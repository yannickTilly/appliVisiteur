...
public class DrugPresentation {
    ...
    @JsonView({ReportView.Report.class, DrugPresentationView.DrugPresentation.class})
    private long id;
    ...
    @JsonView({DrugPresentationView.DrugPresentation.class, ReportView.Report.class})
